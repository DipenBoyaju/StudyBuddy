...
const DashboardPage = () => {
  ...
  if (!dashboardData || !dashboardData.overview) {
    return (
      <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50 items-center justify-center">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={activity.id || index} className="group flex items-center justify-between p-4 rounded-xl bg-slate-50/50 border border-slate-200/60 hover:bg-white hover:border-slate-300/60 hover:shadow-md transition-all duration-200">
                  ...
                  {
                    activity.link && (
                      <a href={activity.link} className="ml-4 py-2 text-xs font-semibold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition-all duration-200 whitespace-nowrap">View</a>
                    )
                  }
                </div>
              ))}
