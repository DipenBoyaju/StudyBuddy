...
const FlashcardSetCard = ({ flashcardSet }) => {
  ...
  const progressPercemtage = totalCards > 0 ? Math.round((reviewedCount / totalCards) * 100) : 0;
          ...
          totalCards > 0 && (
            <div className="space-y-2">
              ...
              <div className="relative h-2 bg-slate-100 rounded-full overflow-hidden">
                <div className="absolute inset-y-0 left-0 bg-linear-to-r from-amber-500 to-teal-500 rounded-full transition-all duration-500 ease-out" style={{ width: `${progressPercemtage}%` }} />
              </div>
            </div>
          )
        }
